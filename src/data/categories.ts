...
export const categories: Category[] = [
  ...
  },
  {
    ...
    description: {
      et: 'Suuna, peatumise ja manöövri näitamine käega enne pööret või ümberpõiget.',
      ru: 'Показ направления, остановки и манёвра рукой до поворота или объезда.',
      en: 'Showing direction, stopping and manoeuvres by hand before a turn or bypass.',
    },
    icon: 'Hand',
  },
  {
    ...
    order: 12,
    title: {
      et: 'Õueala ja eritsoonid',
      ru: 'Жилая зона и особые зоны',
      en: 'Living zones and special areas',
    },
    description: {
      et: 'Õueala 20 km/h, mängivad lapsed, kiiruspiirangud ja jalakäija eelis.',
      ru: 'Жилая зона 20 км/ч, играющие дети, ограничения скорости и приоритет пешехода.',
      en: 'Living zone 20 km/h, children at play, speed limits and pedestrian priority.',
    },
    icon: 'Home',
  },
  {
    ...
    title: {
      et: 'Sõitjad ja pagas',
      ru: 'Пассажиры и багаж',
      en: 'Passengers and cargo',
    },
    description: {
      et: 'Lapseiste, haagis, pagas ja tulede nähtavus koormaga.',
      ru: 'Детское кресло, прицеп, багаж и видимость фонарей с грузом.',
      en: 'Child seats, trailers, luggage and keeping lights visible when loaded.',
    },
    icon: 'Package',
  },
  {
    ...
    order: 14,
    title: {
      et: 'Keelud ja ohtlik käitumine',
      ru: 'Запреты и опасное поведение',
      en: 'Prohibitions and unsafe riding',
    },
    description: {
      et: 'Telefon, joove, katkised pidurid, rööpad ja vanusepiirangud.',
      ru: 'Телефон, опьянение, сломанные тормоза, рельсы и возрастные запреты.',
      en: 'Phone use, intoxication, broken brakes, rails and age limits.',
    },
    icon: 'Ban',
  },
  {
    ...
    description: {
      et: 'Ringristmik, tramm, bussipeatus ja väljuvad reisijad.',
      ru: 'Кольцо, трамвай, автобусная остановка и выходящие пассажиры.',
      en: 'Roundabouts, trams, bus stops and alighting passengers.',
    },
    icon: 'RotateCw',
  },
];
